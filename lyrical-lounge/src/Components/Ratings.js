...
function Ratings({data}){
    ...
    const remove = async (id) => {
      try {
        let res = await axios.post(
          "http://localhost/Comp333-Project-Matt-Emmett-Fullstack/lyrical-lounge/src/backEnd/index.php/rating/delete",
          { id: id }
        );
        console.log(id);
    ...
    const getListRatings = async () => {
        try {
          const response = await fetch('http://localhost/Comp333-Project-Matt-Emmett-Fullstack/lyrical-lounge/src/backEnd/index.php/rating/list');
          if (!response.ok) {
